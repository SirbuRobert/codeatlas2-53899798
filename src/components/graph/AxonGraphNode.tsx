    ...
    >
      ...
      >
        ...
        <div className="px-3 py-2.5">
              ...
              <div className="w-12 h-1 rounded-full bg-surface-3 overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    background: metadata.complexity >= 15 ? '#ef4444' : metadata.complexity >= 10 ? '#f59e0b' : '#22c55e',
                  }}
                />
              </div>
            </div>
          ...
          {/* Flag chips */}
          {metadata.flags.includes('single-point-of-failure') && (
      ...
      <Handle
        ...
        style={{ background: config.color, width: 6, height: 6, border: `1px solid ${config.color}80` }}
      />
      <Handle
        type="source"
      ...
      <Handle
        ...
        id="left"
        style={{ background: config.color, width: 4, height: 4 }}
      />
      <Handle
        type="source"
