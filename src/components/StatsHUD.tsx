  ...
  const items = [
    {
      ...
      tooltip: 'Click to light up every file in the graph.',
      clickable: true,
    },
    {
      icon: TrendingUp,
      ...
      sub: stats.avgComplexity > 10 ? 'yikes 👀' : 'pretty clean 👌',
    ...
    },
    {
      ...
      sub: liveHotspotsCount > 0 ? 'touch at your own risk' : 'all good!',
    ...
    },
    {
      ...
      sub: liveOrphansCount > 0 ? 'nobody imports them 👻' : 'no ghosts here',
    ...
    },
    {
      ...
      sub: liveCircularCount > 0 ? 'who imports who?? 🤯' : 'no snakes eating tails',
    ...
    },
    {
      ...
      color:
        liveCoverageCount === 0
          ...
          ? 'hsl(var(--warning))'
          : 'hsl(var(--destructive))',
      sub: liveCoverageCount === 0 ? 'tested like a champ' : 'low coverage files',
